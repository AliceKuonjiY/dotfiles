;;; doom-yhu-moonlight-theme.el --- inspired by VS code's Moonlight -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;;
(defgroup doom-yhu-moonlight-theme nil
  "Options for the `doom-yhu-moonlight' theme."
  :group 'doom-themes)

(defcustom doom-yhu-moonlight-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-yhu-moonlight-theme
  :type '(choice integer boolean))

;;
(def-doom-theme doom-yhu-moonlight
  ...
  ((bg         '("#212337" "#212337"  "black"))
   ...
   (-modeline-pad
    (when doom-yhu-moonlight-padded-modeline
      (if (integerp doom-yhu-moonlight-padded-modeline) doom-yhu-moonlight-padded-modeline 4))))
  ...
  ((font-lock-builtin-face              :foreground builtin :weight 'bold)
   ...
   ;;;; lsp-mode
   (lsp-face-highlight-read :underline t)
   (lsp-face-highlight-textual :underline t)
   (lsp-face-highlight-write :underline t)
...
;;; doom-yhu-moonlight-theme.el ends here
